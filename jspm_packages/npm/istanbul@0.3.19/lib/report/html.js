...
(function(process) {
  ...
  handlebars.registerHelper('show_picture', function(opts) {
    ...
    if (isFinite(num)) {
      ...
      num = Math.floor(num);
      rest = 100 - num;
      return '<span class="cover-fill' + cls + '" style="width: ' + num + 'px;"></span>' + '<span class="cover-empty" style="width:' + rest + 'px;"></span>';
    } else {
      return '';
    }
  });
